                                    ...
                                    <div class="card-body p-4 p-lg-5 text-black">
                                        <form action='../Controllers/loginController.php' method="get">
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="email" required class="form-control form-control-lg" id="login_email" name='email'  />
                                                <label class="form-label" for="form2Example17">Your email </label>
                                                <label for="" id="login_email_msg"></label>
                                            </div>
                                            <!-- password field -->
                                            <div class="form-outline mb-4">
                                                <input type="password" required class="form-control form-control-lg" id="login_pswd" name='pswd' />
                                                <label class="form-label" for="form2Example27">Password</label>
                                                <label for="" id="login_pswd_msg"></label>
                                            </div>
                                            <!-- login button -->
                                            <div class="pt-1 mb-4">
                                                <input type="submit" required value="login" class="btn btn-dark btn-lg btn-block" class="btn btn-dark btn-lg btn-block">
                                            </div>
                                            <!-- sign in link -->
